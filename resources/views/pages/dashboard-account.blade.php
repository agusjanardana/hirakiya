      ...
      <div class="row">
        <div class="col-12">
          <form action="{{ route('dashboard-settings-redirect', 'dashboard-settings-account') }}" method="POST"
            enctype="multipart/form-data" id="accountData">
            @csrf
            <div class="card">
              <div class="card-body">
                <div class="row mb-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select name="provinces_id" id="provinces_id" class="form-control" v-if="provinces"
                        ...
                        <option value="{{ $user->provinces_id }}">Tidak di ganti</option>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select name="regencies_id" id="regencies_id" class="form-control" v-if="regencies"
                        ...
                        <option value="{{ $user->regencies_id }}">Tidak di ganti</option>
