...
<div class="page-content page-cart">
    ...
    <section class="store-cart">
        <div class="container">
            ...
            <form action="{{ route('checkout') }}" id="lokasi" enctype="multipart/form-data" method="POST">
                @csrf
                {{-- buat input hidden untuk menyimpan value totalprice yang akan diget di controller --}}
